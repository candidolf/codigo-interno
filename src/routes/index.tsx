      ...
      <main className="container mx-auto px-6">
        <section className="pt-20 pb-24 text-center">
          ...
          <p className="mt-6 max-w-2xl mx-auto text-lg text-muted-foreground">
            Uma jornada por salas temáticas onde a IA conversa, observa e devolve um relatório
            profundo sobre quem você é — para você ou para alguém que você ama.
          </p>
        ...
        <section className="grid md:grid-cols-2 gap-8 pb-24 items-center">
          ...
          <div className="glass rounded-3xl p-8 grid grid-cols-2 gap-3">
            {["☀️ Alegria", "🌙 Medo", "🔥 Raiva", "🧭 Descobertas"].map((n) => (
              <div
                key={n}
                className="aspect-square rounded-2xl bg-gradient-brand-soft border border-border grid place-items-center font-display font-bold text-xl"
              >
                {n}
              </div>
            ))}
        ...
        <div className="container mx-auto px-6 py-14 grid gap-10 md:grid-cols-4">
          <div className="md:col-span-2">
            ...
            <p className="mt-4 text-sm text-muted-foreground max-w-sm">
              Avaliação comportamental gamificada conduzida por IA. Uma jornada por salas temáticas
              para entender quem você é.
            </p>
            <div className="mt-5 flex items-center gap-3">
              <a
                href="mailto:contato@metodocodigointerno.com.br"
                aria-label="Email"
                className="grid place-items-center h-9 w-9 rounded-full glass hover:bg-secondary/80 transition-colors"
              >
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-muted-foreground">
              <li>
                <Link to="/comprar" className="hover:text-foreground transition-colors">
                  Comprar teste
                </Link>
              </li>
              <li>
